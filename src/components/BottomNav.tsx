...
const navItems = [
  {
    ...
    label: '홈',
    icon: (active: boolean) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill={active ? '#111' : 'none'} stroke={active ? '#111' : '#aaa'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
        <polyline points="9 22 9 12 15 12 15 22" stroke={active ? 'white' : '#aaa'} />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (active: boolean) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#111' : '#aaa'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="5" r="1.5" fill={active ? '#111' : '#aaa'} />
        <circle cx="12" cy="12" r="1.5" fill={active ? '#111' : '#aaa'} />
        <circle cx="12" cy="19" r="1.5" fill={active ? '#111' : '#aaa'} />
      </svg>
    ),
  },
];
